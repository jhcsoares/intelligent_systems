...
class GeneticAlgorithm:
    ...
    def __generate_first_population(cls) -> None:
        ...
        for _ in range(0, cls.population_size):
            victims_id_list = random.sample(list(cls.victims_unified_map.keys()), len(cls.victims_unified_map))
            random.shuffle(victims_id_list)
            cls.population_data["old_generation"]["population_list"].append(victims_id_list)

    @classmethod
    def __fitness_function(cls, victim_id: int) -> int:
        victim_data = cls.victims_unified_map[victim_id]
        coordinates = victim_data[0]
        health_signals = victim_data[1]
        
        euclidian_distance = math.sqrt(math.pow(coordinates[0], 2) + math.pow(coordinates[1], 2))
        pqa = health_signals[3]
        pulse = health_signals[4]
        heart_rate = health_signals[5]

        return 10*1/euclidian_distance + pqa*-1 + pulse/10 + heart_rate
    ...
    def __breeding_individuals(
        cls, population_list, accumulated_probability_list
    ) :
    ...
    @classmethod
    def __crossover(
        cls, final_chromosome_breeding_1, final_chromosome_breeding_2
    ) :
        if random.random() <= cls.crossover_rate:
            ...
            offspring_2 = final_chromosome_breeding_1[crossover_slice_index:len(final_chromosome_breeding_1)]
    ...
    def __generate_offsprings(
        ...
        while breedings_list:
            ...
            offspring_1, offspring_2 = cls.__crossover(
                breeding_1, breeding_2
            )
    ...
    def __select_final_population(cls):
        fitness_results_list = cls.population_data["new_generation"]["fitness_results_list"]
        ...
        final_population = cls.population_data["new_generation"]["population_list"][best_fitness_value_index]
    ...
    @classmethod
    def execute(cls, population_size: int,
        generations: int,
...
if __name__ == "__main__":
    print((GeneticAlgorithm.execute(
        population_size=16,
        generations=10000,
        crossover_rate=0.8,
        mutation_rate=0.04,
        victims_unified_map={38: ((-3, 8), [38, 5.306324, 2.249959, -8.719746, 125.191957, 14.08686]), 39: ((0, 9), [39, 11.431293, 8.791381, -0.0, 132.188912, 9.174637]), 35: ((8, 9), [35, 14.716378, 8.118869, 1.70998, 60.346905, 10.946475]), 11: ((9, 9), [11, 12.523228, 11.83743, 0.367473, 45.521644, 8.15041]), 17: ((11, 7), [17, 20.212045, 6.0687, 4.765973, 116.558193, 10.77054]), 19: ((6, 6), [19, 18.187442, 5.487243, 4.773315, 175.802781, 2.707842]), 3: ((8, 6), [3, 13.53279, 8.097442, 0.733333, 66.812825, 18.422887]), 32: ((11, 6), [32, 12.735976, 6.2728, -0.0, 169.035637, 14.78786]), 2: ((13, 5), [2, 14.729957, 1.788218, -6.592956, 163.704849, 18.791823]), 24: ((11, 4), [24, 16.191573, 14.591113, 8.733333, 197.990041, 13.974354]), 5: ((11, 3), [5, 18.09571, 7.191948, 4.666667, 22.341149, 0.373625]), 14: ((12, 1), [14, 12.609438, 7.586974, 0.718312, 74.111905, 15.523695]), 21: ((11, -1), [21, 19.59081, 9.418446, 4.690964, 0.104475, 3.223328]), 33: ((7, 3), [33, 13.77814, 9.901845, 4.795896, 147.728058, 18.765959]), 4: ((8, 3), [4, 14.107792, 9.683278, 3.773222, 17.990136, 12.761988]), 25: ((11, -3), [25, 17.992675, 2.880425, -4.355487, 105.536014, 6.201071]), 37: ((5, 3), [37, 15.085302, 5.21569, 4.6954, 16.696563, 12.429551]), 13: ((5, 2), [13, 11.339571, 6.280149, 1.572637, 70.142535, 0.703802]), 16: ((-1, 5), [16, 10.002052, 0.953871, -4.788282, 139.33344, 1.089717]), 30: ((-1, 4), [30, 12.661543, 7.955163, 0.666667, 80.170498, 12.79403]), 9: ((5, 1), [9, 14.280553, 8.158289, 3.953607, 37.942081, 18.586825]), 15: ((7, 0), [15, 18.371217, 1.645462, -4.333333, 185.921773, 7.973052]), 41: ((9, -2), [41, 16.639092, 0.666811, -4.333333, 178.150423, 20.854529]), 28: ((-5, -5), [28, 15.230446, 1.4073, -4.343757, 45.568587, 14.980552]), 10: ((-5, 3), [10, 11.034661, 10.815699, 4.225599, 70.001165, 15.606912]), 6: ((-3, 0), [6, 14.488171, 9.589754, 4.166508, 27.25851, 2.658911]), 20: ((-2, -1), [20, 15.637701, 11.45257, 8.531563, 197.782323, 4.520872]), 27: ((-5, -7), [27, 14.229343, 10.443995, 4.568335, 160.269521, 15.293587]), 36: ((-4, -7), [36, 20.356882, 7.800787, 4.666667, 133.283243, 4.58615]), 29: ((-1, -5), [29, 13.074266, 7.881066, 0.737126, 60.618858, 14.787623]), 34: ((0, -7), [34, 21.87919, 10.071467, 4.824627, 117.197407, 19.226403]), 1: ((2, -3), [1, 18.954033, 4.771111, -6.834524, 157.992606, 19.91864]), 7: ((13, -10), [7, 17.621876, 8.170742, 4.666667, 135.730461, 18.979636]), 8: ((9, -3), [8, 14.362646, 9.709672, 1.728601, 99.035404, 10.654523]), 31: ((8, -5), [31, 14.900526, 7.917097, 0.733333, 74.932244, 12.72651]), 18: ((8, -8), [18, 12.700682, 6.725594, 1.738791, 163.079442, 4.235229]), 22: ((6, -9), [22, 19.447831, 11.579706, 8.554259, 173.087718, 4.159588]), 40: ((5, -7), [40, 11.284967, 3.93218, -4.598273, 145.950371, 4.531461]), 0: ((2, -8), [0, 12.137933, 6.323999, 0.615687, 70.460645, 16.012553]), 12: ((2, -7), [12, 14.915804, 8.905569, 0.733333, 67.994829, 13.857434]), 23: ((3, -6), [23, 17.014684, 13.992804, 8.733333, 122.513294, 0.938353])}
    )))
