...
def main(data_folder_name):
    ...
    exp1 = Explorer(env, explorer_file, resc1, "u")
    exp2 = Explorer(env, explorer_file, resc1, "d")
    exp3 = Explorer(env, explorer_file, resc1, "l")
    exp4 = Explorer(env, explorer_file, resc1, "r")
